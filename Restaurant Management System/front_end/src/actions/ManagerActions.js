...
export const getMOrders = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:7000/manager/orders'
...
export const getChefs = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:7000/admin/chefs'
...
export const getAllWaiters = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:7000/admin/waiters'
...
export const assignWaiterToTable = (waiterId, tableNo) => {
  return (dispatch) => {
    ...
    const url = `http://localhost:7000/waiter/assign/${waiterId}/${tableNo}`
